          ...
          <div className="flex-1 flex flex-col gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-xl py-6 flex flex-col items-center justify-center shadow-sm border border-gray-100">
                ...
                <span className="text-gray-600 text-[13px] mt-1">
                  Next Due
                </span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-3 gap-4">
                <button className="flex flex-col items-center justify-center gap-2 py-4 border border-gray-100 rounded-lg hover:bg-gray-200 bg-gray-100 cursor-pointer transition-all">
                  <Phone size={20} className="text-gray-700" />
                  <span className="text-[13px] text-gray-600 font-medium">
                    Call
                  </span>
                </button>
                <button className="flex flex-col items-center justify-center gap-2 py-4 border border-gray-100 rounded-lg hover:bg-gray-200 bg-gray-100 transition-all cursor-pointer">
